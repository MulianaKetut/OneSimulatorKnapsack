...
public class RapidWithKnapsackRouter extends ActiveRouterMul  {
     ...
     */
    protected RapidWithKnapsackRouter(RapidWithKnapsackRouter r) {
        super(r);
    ...
    public void ckeckConnectionStatus() {
        ...
        for (Connection con : getConnections()) {
            ...
            RapidWithKnapsackRouter otherRouter = (RapidWithKnapsackRouter) other.getRouter();
    ...
    private void doHostMapping(Connection con) {
        ...
        RapidWithKnapsackRouter otherRouter = ((RapidWithKnapsackRouter) otherHost.getRouter());
    ...
    public int receiveMessage(Message m, DTNHost from) {
        Collection<Message> msg = this.getMessageCollection();
//        System.out.println(msg);
//        for (Message ms : msg) {
//            System.out.println(m.getProperty("value"));
//            System.out.println(ms.getProperty("value"));
//            Double coba = (Double) m.getProperty("value");
//            Double coba1 = (Double) ms.getProperty("value");
//            if (coba > coba1) {
//                if (m.getSize() > this.getFreeBufferSize()) {
//                    //masih coba
//                    super.makeRoomForNewMessage(m.getSize());
//                    return 0;
//                }
//                if (m.getSize() < this.getBufferSize()) {
//                    return 0;// message too big for the buffer
//                }
//            }
//
//        }
        ...
        if (stat == 0) {
            ...
            ((RapidWithKnapsackRouter) from.getRouter()).updateDelayTableEntry(m, host, delay, time);
        }
    ...
    private double getMarginalUtility(Message msg, Connection con, DTNHost host) {
        final RapidWithKnapsackRouter otherRouter = (RapidWithKnapsackRouter) (con.getOtherNode(host).getRouter());
        //utilityMsg.put(msg.getId(), getMarginalUtility(msg, otherRouter, host));
     ...
     * @return the current MU value
     */
    private double getMarginalUtility(Message msg, RapidWithKnapsackRouter router, DTNHost host) {
...
//        Double u = marginalUtility;
//        System.out.println("pesan"+msg);
//        msg.addProperty("value", u);
    ...
    private double computeRemainingTime(Message msg) {
        ...
        if (delayTable.getDelayEntryByMessageId(msg.getId()) != null) {
            ...
            for (Entry<DTNHost, Tuple<Double, Double>> entry : delayTable.getDelayEntryByMessageId(msg.getId()).getDelays()) {
                ...
                transferTime = ((RapidWithKnapsackRouter) host.getRouter()).computeTransferTime(msg, msg.getTo()); //MXm(i)	with m element of [0...k]
...
//    }
    ...
    @Override
    public RapidWithKnapsackRouter replicate() {
...
//    public Map<String, Double> getUtilityMsg() {
//        return utilityMsg;
//    }
