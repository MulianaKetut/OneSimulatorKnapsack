 ...
 * {@link #update()}).
 */
public abstract class ActiveRouterMul extends MessageRouter {
     ...
     */
    public ActiveRouterMul(Settings s) {
        super(s);
     ...
     */
    protected ActiveRouterMul(ActiveRouterMul r) {
        super(r);
    ...
    protected Message getOldestMessage(boolean excludeMsgBeingSent) {
        ...
        for (Message m : messages) {
            //System.out.println("ttgfghj "+m.getProperty("value"));
...
//            if((Double)m.getProperty("value") <=0.0){
//                oldest = m;
//            }
//            else if (oldest.getReceiveTime() > m.getReceiveTime()) {
//                oldest = m;
//            } 
            else if ((Double) oldest.getProperty("value") < (Double) m.getProperty("value")) {
                oldest = m;
//                System.out.println("drop "+oldest +"value "+oldest.getProperty("value"));
            }
...
//        public Map<String, Double> getUtility(){
//            return utilityMsg.getUtilityMsg();
//        }
}
